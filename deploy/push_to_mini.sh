...
FILES="cpk_browser.py cpk_collect.py cpk_import.py cpk_keepalive.py cpk_keywords.py \
cpk_queue.py cpk_search.py cpk_session.py cpk_search_json.py \n cpk_domeggook.py cpk_market.py cpk_market_db.py cpk_market_score.py cpk_market_collect.py cpk.env.example requirements.txt"
